    ...
    <div id ="main-container" style="height: 100%;width: 100%;margin: 0%;padding: 0%;display:flex;">
        <div id ="principal" style="width: 50%; min-height: 100vh;background-color: #FCDA68;display: flex;justify-content: center;flex-direction: column;">
            <div style="height:50%;">
                ...
                <div style="width: 60%;margin:auto;"><h3 style="font-family:'Inter';color: #ffffff;text-align: center;font-size:1.8vw;">Ayuda a nuestros mas fieles compañeros a estar de vuelta con sus adorados dueños</h3></div>
            </div>
        ...
        <div id = "formulario"  style="background-color: #ffffff;width: 50%;  min-height: 100vh;  ">
            <div style="text-align: center;height:15vh">
                <h3 style="font-family: 'Inter';color: #2D2B40;font-size:2vw;text-align:center;font-weight:bold">Te damos la bienvenida a nuestro portal</h3>
            ...
            <div id = "form" style = "height:40vh;width:100%;display:flex;font-family:'Inter';font-size: 0.8vw;align-content:center;">
                <form method ="POST" action="" style="margin:auto;margin-top:3vh; ">
                    ...
                    <input pattern ="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required minlength="8"  required autocomplete="new-password" style = "font-size: 0.70vw;font-family:'Inter';margin-top:0.5vh;margin-bottom: 8vh;border:none;border-radius:6px;background-color:EFEFEF;width: 40vw;padding:0.6vw;outline:none;" type="password" id="fcon" name="fcon" placeholder="Incluya una mayuscula y un número"><br>
